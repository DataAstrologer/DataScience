...
The above model, trained using sample data, was used for generating predictions for the test dataset from Kaggle. The final accuracy was found to be: **0.96468**.