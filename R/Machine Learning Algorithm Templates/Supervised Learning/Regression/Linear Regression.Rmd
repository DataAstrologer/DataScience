...
* The Residual Standard Error is the standard deviation of the errors (i.e., predicted values using the regression line subtracted by the actual value).
...
In order to do predictions using the final model above, we use the ```predict()``` function in R. 
```{r}
